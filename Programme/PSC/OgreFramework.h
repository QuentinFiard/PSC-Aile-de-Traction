...
#else
class OgreFramework : public Ogre::Singleton<OgreFramework>, OIS::KeyListener, OIS::MouseListener, OIS::JoyStickListener, OgreBites::SdkTrayListener
#endif
{
public:
	OgreFramework();
...
#else
	bool initOgre(Ogre::String wndTitle, OIS::KeyListener *pKeyListener = 0, OIS::MouseListener *pMouseListener = 0, OIS::JoyStickListener *pJoyStickListener = 0);
#endif
	...
	bool vector3Moved (const OIS::JoyStickEvent &arg, int Vector3ID);
